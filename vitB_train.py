...
log_file = '/home/swarnendu-sengupta/Work_NO_SHARE/SARIFA_multi_class/logs/vitB_training.log'
logging.basicConfig(
        filename=log_file,
        filemode='w',
...
dataset_folder = '/home/swarnendu-sengupta/Work_NO_SHARE/SARIFA_multi_class/data_augment'
...
MODEL_TRAINING(train_dataset = train_dataset, val_dataset = val_dataset, test_dataset = test_dataset,
            class_names = dataset.classes, train_class_labels = train_labels, log_file = log_file, save_path = model_save_path,
                  model_type='vitb', learning_rate=1e-4, num_epochs=500, batch_size=256)
